...
lenet = Image.open(directory + "streamlit_app/assets/images/lenet.jpg")
xception = Image.open(directory + "streamlit_app/assets/images/xception.png")
vgg = Image.open(directory + "streamlit_app/assets/images/vgg.jpg")
resnet = Image.open(directory + "streamlit_app/assets/images/resnet.png")
enet = Image.open(directory + "streamlit_app/assets/images/enet.png")
conf_lenet = Image.open(directory + "streamlit_app/assets/images/2_lenet_conf.png")
courbe_lenet = Image.open(directory + "streamlit_app/assets/images/2_lenet_courbe.png")
conf_resnet = Image.open(directory + "streamlit_app/assets/images/2_resnet_conf.png")
courbe_resnet = Image.open(directory + "streamlit_app/assets/images/2_resnet_courbe.png")
conf_xception = Image.open(directory + "streamlit_app/assets/images/2_xcep_conf.png")
courbe_xception = Image.open(directory + "streamlit_app/assets/images/2_xcep_courbe.png")
conf_vgg = Image.open(directory + "streamlit_app/assets/images/2_vgg_conf.png")
courbe_vgg = Image.open(directory + "streamlit_app/assets/images/2_vgg_courbe.png")
conf_enet = Image.open(directory + "streamlit_app/assets/images/2_enet_conf.png")
courbe_enet = Image.open(directory + "streamlit_app/assets/images/2_enet_courbe.png")
resume_sans = Image.open(directory + "streamlit_app/assets/images/2_classes.png")
resume_masques = Image.open(directory + "streamlit_app/assets/images/2_classes_masques.png")
